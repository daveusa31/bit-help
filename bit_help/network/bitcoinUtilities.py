...
# From repository https://github.com/Chiheb-Nexus/pyBitcoinUtilities
# From file https://github.com/Chiheb-Nexus/pyBitcoinUtilities/blob/master/src/bitcoinUtilities.py
